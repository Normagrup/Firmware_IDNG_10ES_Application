    ...
    #define INC_SENSORES_GRUPOS_CONFIGURACION_S_H
        ...
        typedef struct sensoresGruposConfiguracion_s
        {
            ...
            sensoresAcciones                        accionesDetectoresPresenciaPulsadoresAccionTemporizada[2];
            UINT16                                  reguladoresLuzGanancia; // Guardar del 0 al 0xFFFF donde 0 es 0.001 y 0xFFFF es 65.536 es decir gain * 0.001 + 0.001  Ganancia 1 sería 999
            INT                                     reguladoresLuzOffset;   //[por ejemplo +-254], sin offset sería 0.
						unsigned char                           reguladoresLuzMax; 
            unsigned char                           reguladoresLuzMin; 					
        }sensoresGruposConfiguracion;
        #define SENSORES_GRUPOS_CONFIGURACION_S_SIZE    9
    #endif
#endif
